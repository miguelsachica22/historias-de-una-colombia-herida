<%@ Page Title="" Language="C#" MasterPageFile="~/contenido_juego.Master" AutoEventWireup="true" CodeBehind="quiz_region_pacifico.aspx.cs" Inherits="historias_de_una_colombia_herida.quiz_region_pacifico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" Height="548px">
        <table style="width: 100%; height: 397px;">
            <caption>
                <strong><em>
                <asp:Label ID="Label25" runat="server" style="font-size: medium; color: #339933; text-decoration: underline" Text="Quiz region Pacifico"></asp:Label>
                </em></strong>&nbsp;<br />
            </caption>
            <tr>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:Panel ID="Panel5" runat="server">
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="width: 715px; height: 85px;">
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:memorias_colombiaConnectionString2 %>" DeleteCommand="DELETE FROM [region_pacifico] WHERE [id_prueba] = @id_prueba" InsertCommand="INSERT INTO [region_pacifico] ([identificacion], [nombre_region], [resultado_1], [resultado_2], [resultado_3], [resultado_4], [resultado_5], [resultado_6], [total]) VALUES (@identificacion, @nombre_region, @resultado_1, @resultado_2, @resultado_3, @resultado_4, @resultado_5, @resultado_6, @total)" SelectCommand="SELECT * FROM [region_pacifico]" UpdateCommand="UPDATE [region_pacifico] SET [identificacion] = @identificacion, [nombre_region] = @nombre_region, [resultado_1] = @resultado_1, [resultado_2] = @resultado_2, [resultado_3] = @resultado_3, [resultado_4] = @resultado_4, [resultado_5] = @resultado_5, [resultado_6] = @resultado_6, [total] = @total WHERE [id_prueba] = @id_prueba">
                        <DeleteParameters>
                        ...
                        <InsertParameters>
                            ...
                            <asp:ControlParameter ControlID="lbl_pacifico" Name="nombre_region" PropertyName="Text" Type="String" />
                    ...
                    <strong>
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="identificacion" DataSourceID="SqlDataSource1" style="color: #333333">
                        <EditItemTemplate>
                            identificacion:
                ...
                <td colspan="2" style="height: 85px">
                    <asp:FormView ID="FormView2" runat="server" DataKeyNames="id_prueba" DataSourceID="SqlDataSource2" DefaultMode="Insert" Width="719px">
                        <EditItemTemplate>
                            id_prueba:
                        ...
                        <InsertItemTemplate>
                            ...
                            <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Insert" Height="53px" ImageUrl="~/images/boton_guardar.PNG" />
                        </InsertItemTemplate>
                        <ItemTemplate>
                            id_prueba:
            ...
            <tr>
                <td style="width: 715px"><strong>
                    ...
                    <asp:Label ID="lbl_pacifico" runat="server" Text="Pacifico" Visible="False"></asp:Label>
                    </strong></td>
                <td colspan="2">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="754px" BorderColor="#006600" BorderWidth="2px" CssClass="label-default" style="background-color: #333333">
                        <LocalReport ReportPath="reporte quiz pacifico.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="informe_region_pacifico" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBy" TypeName="historias_de_una_colombia_herida.DataSetTableAdapters.region_pacificoTableAdapter" UpdateMethod="Update">
                        <DeleteParameters>
