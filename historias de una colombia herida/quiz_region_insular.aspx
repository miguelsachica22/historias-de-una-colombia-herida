<%@ Page Title="" Language="C#" MasterPageFile="~/contenido_juego.Master" AutoEventWireup="true" CodeBehind="quiz_region_insular.aspx.cs" Inherits="historias_de_una_colombia_herida.quiz_region_insular" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" Height="480px">
        <table style="width: 100%">
            <caption>
                <strong><em>
                <asp:Label ID="Label25" runat="server" style="font-size: medium; color: #339933; text-decoration: underline" Text="Quiz region Insular"></asp:Label>
                </em></strong>&nbsp;</caption>
            <tr>
                    ...
                    <asp:Panel ID="Panel4" runat="server" Width="365px">
                        <div class="text-right">
                            <table style="width: 100%" border="1">
                                ...
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="LinkButton3" runat="server" style="color: #339933">Confirmar</asp:LinkButton>
                                        <br />
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="width: 715px">
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:memorias_colombiaConnectionString2 %>" DeleteCommand="DELETE FROM [region_insular] WHERE [id_prueba] = @id_prueba" InsertCommand="INSERT INTO [region_insular] ([identificacion], [nombre_region], [resultado_1], [resultado_2], [resultado_3], [resultado_4], [resultado_5], [resultado_6], [total]) VALUES (@identificacion, @nombre_region, @resultado_1, @resultado_2, @resultado_3, @resultado_4, @resultado_5, @resultado_6, @total)" SelectCommand="SELECT * FROM [region_insular]" UpdateCommand="UPDATE [region_insular] SET [identificacion] = @identificacion, [nombre_region] = @nombre_region, [resultado_1] = @resultado_1, [resultado_2] = @resultado_2, [resultado_3] = @resultado_3, [resultado_4] = @resultado_4, [resultado_5] = @resultado_5, [resultado_6] = @resultado_6, [total] = @total WHERE [id_prueba] = @id_prueba">
                        <DeleteParameters>
                        ...
                        <InsertParameters>
                            ...
                            <asp:ControlParameter ControlID="lbl_insular" Name="nombre_region" PropertyName="Text" Type="String" />
                    ...
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="identificacion" DataSourceID="SqlDataSource1">
                        <EditItemTemplate>
                            identificacion:
                        ...
                        <InsertItemTemplate>
                            identificacion:
                            <asp:TextBox ID="identificacionTextBox0" runat="server" Text='<%# Bind("identificacion") %>' />
                            <br />
                        ...
                        <ItemTemplate>
                            &nbsp;<asp:Label ID="identificacionLabel2" runat="server" Text='<%# Eval("identificacion") %>' />
                            <br />
                        </ItemTemplate>
                    </asp:FormView>
                </td>
                <td colspan="2">
                    <asp:FormView ID="FormView2" runat="server" DataKeyNames="id_prueba" DataSourceID="SqlDataSource2" DefaultMode="Insert" Width="727px">
                        <EditItemTemplate>
                            id_prueba:
...
&nbsp;<asp:LinkButton ID="InsertCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancelar" Visible="False" />
                            &nbsp;<asp:ImageButton ID="ImageButton1" runat="server" CommandName="Insert" Height="57px" ImageUrl="~/images/boton_guardar.PNG" />
                        </InsertItemTemplate>
                        <ItemTemplate>
                            id_prueba:
            ...
            <tr>
                <td style="width: 715px"><strong>
                    ...
                    <asp:Label ID="lbl_insular" runat="server" Text="Insular" Visible="False"></asp:Label>
                    </strong></td>
                <td colspan="2">
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="723px" BorderColor="#006600" BorderWidth="2px" CssClass="label-default" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" style="background-color: #333333">
                        <LocalReport ReportPath="Reporte quiz insular.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="informe_region_insular" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBy" TypeName="historias_de_una_colombia_herida.DataSetTableAdapters.region_insularTableAdapter" UpdateMethod="Update">
                        <DeleteParameters>
                        ...
                        <SelectParameters>
                            <asp:ControlParameter ControlID="FormView1" Name="parametro" PropertyName="SelectedValue" Type="Int64" />
                        </SelectParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="identificacion" Type="Int64" />
                            <asp:Parameter Name="nombre_region" Type="String" />
